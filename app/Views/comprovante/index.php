        <div class="container py-2 my-2">
            <div class="d-grid gap-2 mb-4 d-md-flex align-items-center justify-content-md-between">
                <a class="btn btn-light mt-1" href="<?= base_url(); ?>/comprovante/cadastrar" role="button">Criar novo comprovante</a>
            </div>
                    ...
                    <?php foreach ($Comprovante as $comprovante): ?>
                        <div class="col-md-3 mb-3">
                            <div class="card comprovante-card">
                                <a href="<?= base_url(); ?>/comprovante/upload/<?= esc($comprovante['id'])?>" class="btn  focus-ring focus-ring-secondary img-upload">download document</a>
                                ...
                                <div class="card-footer  d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>comprovante/edicao/<?= esc($comprovante['id'], 'url') ?>"><i class="bi bi-pencil-square"></i></a>
                                    <a href="<?= base_url(); ?>comprovante/deletar/<?= esc($comprovante['id'], 'url') ?>"><i class="bi bi-trash3-fill"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach ?>
